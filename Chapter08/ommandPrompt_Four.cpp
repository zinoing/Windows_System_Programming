// CommandPrompt_Four.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int CmdProcessing(int tokenNum) {
	...
	else if (!_tcscmp(cmdTokenList[0], _T("start")))
	{
		if (tokenNum > 1)
		{
			...
			_stprintf(cmdStringWithOptions, _T("%s %s"), _T("CommandPrompt_Four.exe"), optString);
		}
		else {
			_stprintf(cmdStringWithOptions, _T("%s"), _T("CommandPrompt_Four.exe"));
		}
