// nonBlocking_fileIO.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int _tmain(int argc, TCHAR* argv[])
{
	...
	overlappedFilePtr.Offset += _tcslen(strData1) * sizeof(char);
	...
	overlappedFilePtr.Offset += _tcslen(strData2) * sizeof(char);
	...
	overlappedFilePtr.Offset += _tcslen(strData3) * sizeof(char);
